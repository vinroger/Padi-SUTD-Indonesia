...
export default function Layout({ children }) {
    ...
    return <div className="overflow-hidden">
        <Head>
            ...
            <meta name="description" content="Perhimpunan Mahasiswa Indonesia di Singapore University of Technology and Design (PADI SUTD). Learn more about us." />
            <meta name="keywords" content="PADI SUTD Perhimpunan Mahasiswa Indonesia di Singapore" />
        </Head>
        <header>
            <h1 className="hidden">PADI SUTD Perhimpunan Mahasiswa Indonesia di Singapore</h1>
